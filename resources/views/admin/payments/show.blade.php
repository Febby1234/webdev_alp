                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            {{-- Sender Bank --}}
                            <div>
                                <label class="text-xs font-medium text-gray-500 uppercase">Bank Pengirim</label>
                                <p class="text-gray-900 mt-1">{{ $payment->sender_bank ?? '-' }}</p>
                            </div>

                            {{-- Sender Account Name --}}
                            <div>
                                <label class="text-xs font-medium text-gray-500 uppercase">Nama Pengirim</label>
                                <p class="text-gray-900 mt-1">{{ $payment->sender_account_name ?? '-' }}</p>
                            </div>

                            {{-- Payment Date --}}
                            <div>
                                <label class="text-xs font-medium text-gray-500 uppercase">Tanggal Transfer</label>
                                <p class="text-gray-900 mt-1">
                                    {{ $payment->payment_date?->format('d F Y, H:i') ?? $payment->created_at->format('d F Y, H:i') }}
                                </p>
                            </div>
