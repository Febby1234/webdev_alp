            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold mb-6 text-gray-900">
                        Semua Jadwal Ujian ({{ count($schedules ?? []) }})
                    </h3>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-3">
                                            ...
                                            @if(($schedule->registrations_count ?? 0) == 0)
                                            <form method="POST"
                                                  action="{{ route('admin.schedules.destroy', $schedule->id) }}"
                                                  class="inline"
                                                  onsubmit="return confirm('Yakin ingin menghapus jadwal {{ $schedule->type }}?')">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <button type="button"
                                                    ...
                                                    title="Tidak dapat menghapus jadwal yang sudah memiliki peserta">
                                                <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        ...
                                        <p class="text-gray-500 text-lg mb-4">Belum ada jadwal ujian</p>
                                        <a href="{{ route('admin.schedules.create') }}"
                                           class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 transition">
                                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
