                    ...
                    <div class="bg-gradient-to-r from-purple-600 to-purple-700 rounded-lg p-6 text-white mb-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-purple-100 mt-1 mb-4">{{ $my_schedule->batch->name ?? 'Gelombang ' . date('Y') }}</p>

                                {{-- TOMBOL CETAK KARTU (DISINI POSISINYA) --}}
                                <a href="{{ route('student.exams.print_card') }}" target="_blank"
                                   class="inline-flex items-center px-4 py-2 bg-white text-purple-700 font-bold rounded-lg shadow-md hover:bg-gray-100 transition duration-150 ease-in-out text-sm">
