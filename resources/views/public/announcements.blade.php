...
<div class="bg-gradient-to-br from-blue-600 to-blue-800 py-16 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-xl text-blue-100">Informasi terbaru seputar PPDB {{ date('Y') }}</p>
    </div>
</div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    ...
                    <div class="flex items-start flex-1">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <div class="mt-4 flex items-center">
                                ...
                                <a href="{{ $announcement->attachment }}" class="text-blue-600 hover:text-blue-800 font-medium">
                                    Download Lampiran
                                </a>
                            </div>
                            @endif
    ...
    {{-- Subscribe Box --}}
    <div class="mt-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-8 text-white">
        <div class="max-w-2xl mx-auto text-center">
            <h3 class="text-2xl font-bold mb-4">Dapatkan Notifikasi Pengumuman Terbaru</h3>
            <p class="text-blue-100 mb-6">Daftar sekarang dan dapatkan notifikasi langsung via email</p>
            <div class="flex gap-4 max-w-md mx-auto">
                <input type="email"
                       placeholder="email@anda.com"
                       class="flex-1 px-4 py-3 rounded-lg text-gray-900 focus:ring-2 focus:ring-white">
                <button class="px-6 py-3 bg-white text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition">
                    Berlangganan
                </button>
            </div>
        </div>
