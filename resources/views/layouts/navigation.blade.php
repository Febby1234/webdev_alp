        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('student.exams.schedule')" :active="request()->routeIs('student.exams.*')">
                        {{ __('Ujian') }}
                    </x-nav-link>
                </div>
                @endif
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.documents.verify')" :active="request()->routeIs('admin.documents.*')">
                        {{ __('Dokumen') }}
                    </x-nav-link>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('interviewer.schedule.index')" :active="request()->routeIs('interviewer.schedule.*')">
                        {{ __('Jadwal') }}
                    </x-nav-link>
                </div>
                @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(auth()->user()->role === 'student')
                ...
                <x-responsive-nav-link :href="route('student.exams.schedule')" :active="request()->routeIs('student.exams.*')">
                    {{ __('Ujian') }}
                </x-responsive-nav-link>
