                ...
                @auth
                    @if (auth()->user()->role === 'student')
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <x-nav-link :href="route('student.registration.show')" :active="request()->routeIs('student.registration.*')">
                                {{ __('Pendaftaran') }}
                            </x-nav-link>
                            <x-nav-link :href="route('student.documents.index')" :active="request()->routeIs('student.documents.*')">
                                {{ __('Dokumen') }}
                            </x-nav-link>
                            <x-nav-link :href="route('student.payments.index')" :active="request()->routeIs('student.payment.*')">
                                {{ __('Pembayaran') }}
                            </x-nav-link>
                            <x-nav-link :href="route('student.exams.schedule')" :active="request()->routeIs('student.schedule')">
                                {{ __('Jadwal') }}
                            </x-nav-link>
                            <x-nav-link :href="route('student.exams.results')" :active="request()->routeIs('student.results.*')">
                                {{ __('Hasil') }}
                            </x-nav-link>
                        </div>
                    @endif
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                <x-dropdown align="left" width="48">
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <x-dropdown-link :href="route('admin.majors.index')">
                                            {{ __('Jurusan') }}
                                        </x-dropdown-link>
                                        ...
                                        <x-dropdown-link :href="route('admin.announcements.create')">
                                            {{ __('Pengumuman') }}
                                        </x-dropdown-link>
                                        <x-dropdown-link :href="route('admin.reports.export')">
                                            {{ __('Laporan') }}
                                        </x-dropdown-link>
                                    </x-slot>
                                </x-dropdown>
        ...
        <div class="pt-2 pb-3 space-y-1">
            @auth
                @if (auth()->user()->role === 'student')
                    ...
                    <x-responsive-nav-link :href="route('student.registration.show')" :active="request()->routeIs('student.registration.*')">
                        {{ __('Pendaftaran') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('student.documents.index')" :active="request()->routeIs('student.documents.*')">
                        {{ __('Dokumen') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('student.payments.index')" :active="request()->routeIs('student.payment.*')">
                        {{ __('Pembayaran') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('student.exams.schedule')" :active="request()->routeIs('student.schedule')">
                        {{ __('Jadwal') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('student.exams.results')" :active="request()->routeIs('student.results.*')">
                        {{ __('Hasil') }}
                    </x-responsive-nav-link>
